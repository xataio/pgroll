...
generate:
	# Format JSON schema
	docker run --rm -v $$PWD/schema.json:/mnt/schema.json node npx prettier /mnt/schema.json --parser json --tab-width 2 --single-quote --trailing-comma all --no-semi --arrow-parens always --print-width 120 > schema.json.tmp
