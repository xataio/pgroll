...
* **Column order is preserved**: When specifying multiple columns, the order in which they appear in the JSON/YAML file is maintained in the created index. This is important for multi-column indexes where column order affects query optimization.
