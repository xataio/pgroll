					...
					Operations: migrations.Operations{
						&migrations.OpAlterColumn{
							...
							References: &migrations.ForeignKeyReference{
								...
								Table:    "users",
								Column:   "id",
								OnDelete: ptr(migrations.ForeignKeyReferenceOnDelete("SET NULL")),
							},
							Up:   "(SELECT CASE WHEN EXISTS (SELECT 1 FROM users WHERE users.id = user_id) THEN user_id ELSE NULL END)",
							Down: "user_id",
						},
					...
					Operations: migrations.Operations{
						&migrations.OpAlterColumn{
							...
							References: &migrations.ForeignKeyReference{
								...
								Table:    "users",
								Column:   "id",
								OnDelete: ptr(migrations.ForeignKeyReferenceOnDelete("SET DEFAULT")),
							},
							Up:   "(SELECT CASE WHEN EXISTS (SELECT 1 FROM users WHERE users.id = user_id) THEN user_id ELSE NULL END)",
							Down: "user_id",
						},
					...
					Operations: migrations.Operations{
						&migrations.OpAlterColumn{
							...
							References: &migrations.ForeignKeyReference{
								...
								Table:    "users",
								Column:   "id",
								OnDelete: ptr(migrations.ForeignKeyReferenceOnDelete("invalid")),
							},
							Up:   "(SELECT CASE WHEN EXISTS (SELECT 1 FROM users WHERE users.id = user_id) THEN user_id ELSE NULL END)",
							Down: "user_id",
						},
					...
					Operations: migrations.Operations{
						&migrations.OpAlterColumn{
							...
							References: &migrations.ForeignKeyReference{
								...
								Table:    "users",
								Column:   "id",
								OnDelete: ptr(migrations.ForeignKeyReferenceOnDelete("no action")),
							},
							Up:   "(SELECT CASE WHEN EXISTS (SELECT 1 FROM users WHERE users.id = user_id) THEN user_id ELSE NULL END)",
							Down: "user_id",
						},
